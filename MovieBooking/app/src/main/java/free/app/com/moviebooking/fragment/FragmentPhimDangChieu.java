...
public class FragmentPhimDangChieu extends Fragment implements Callback<List<Phim>>{
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view=inflater.inflate(R.layout.fragment_phim_dang_chieu,container,false);
        recyclerView= (RecyclerView) view.findViewById(R.id.phim_dang_chieu);
    ...
    public void getData(){
        ...
        Call<List<Phim>> call = gerritAPI.phimdangchieu();
        call.enqueue(this);
    }
