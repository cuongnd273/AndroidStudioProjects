...
public class GCMRegistrationIntentService extends IntentService {
    ...
    private void registerGCM() {
        ...
        try {
            ...
            token = instanceID.getToken(getString(R.string.gcm_id), GoogleCloudMessaging.INSTANCE_ID_SCOPE, null);
            ...
            Log.w("GCMRegIntentService", "Registration error"+e.toString());
...
//        paramPost.put("action","add");
        paramPost.put("gcm_id", token);
        try {
            String msgResult = getStringResultFromService_POST("http://itpsoft.com.vn/WebserviesEnglish/GCM/creatnguoidung.php", paramPost);
            Log.i("ServiceResponseMsg", msgResult);
        }catch (Exception e){
            e.printStackTrace();
        }
    }
