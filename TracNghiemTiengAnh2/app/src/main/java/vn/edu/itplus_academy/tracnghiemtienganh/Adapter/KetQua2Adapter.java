 ...
 */
public class KetQua2Adapter extends RecyclerView.Adapter<KetQua2Adapter.MyViewHolder> {
    ...
    public KetQua2Adapter(Activity context, List<CauHoi> list) {
    ...
    public MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        if(viewType == TYPE_HEAD){
            view = mLayoutInflater.inflate(R.layout.item_ketqua2, parent, false);
    ...
    public class MyViewHolder extends  RecyclerView.ViewHolder implements View.OnClickListener{
        ...
        //header
        public TextView ID,DapAn,DapAnDung;
